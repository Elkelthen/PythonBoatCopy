...
class Driver:
    ...
    def get_heading(self) -> float:
        """
        JRG Added, returns a heading in degrees. Conforms with interface.
        """
        mag_value = self.read_magnetometer()
        heading = 180 * math.atan2(mag_value[1], mag_value[2]) / math.pi
    ...
    def get_real_accel(self):
        """
        JRG Added to conform with interface.
        """
